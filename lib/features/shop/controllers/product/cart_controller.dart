...
class CartController extends GetxController{
  ...
  void addToCart(ProductModel product){
    ...
    // check if oriduct is alread in cart 
...
void updateAlreadyAddedProductCount(ProductModel product){
  ...
  // convets productmodel to CartItemModel 
  CartItemModel convertToCartItem(ProductModel product, int quantity){
    ...
    final price = isVariation ? variation.salePrice > 0.0 ?
    variation.salePrice : variation.price : product.salePrice > 0.0 ? product.salePrice : product.price;
