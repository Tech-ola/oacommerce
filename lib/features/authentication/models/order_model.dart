...
class OrderModel {
  ...
  OrderModel({
    ...
    String get formattedOrderDate => orderDate != null ? THelperFunctions.getFormattedDate(orderDate!) : '';
    ...
    factory OrderModel.fromSnapshot(DocumentSnapshot snapshot){
      ...
      return OrderModel(
        ...
        orderDate: data['OrderDate'] == null ? null : (data['OrderDate'] as Timestamp).toDate(),
