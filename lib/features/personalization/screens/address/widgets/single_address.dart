    ...
    return Obx(() {
      ...
      final selectedAddress = selectedAddressId == address.id;
        ...
        child: TRoundedContainer(
                    ...
                    backgroundColor: selectedAddress ? TColors.primary.withOpacity(0.5) : Colors.transparent,borderColor: selectedAddress ? Colors.transparent : dark ? TColors.darkerGrey : TColors.grey,
